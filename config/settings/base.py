...
LOCAL_APPS = [
    ...
    'questionbank.comments.apps.CommentsConfig',
    'questionbank.analyses.apps.AnalysesConfig'
]
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar': 'questionbank',
        # put selected toolbar config here 'mathJaxLib': '//cdn.mathjax.org/mathjax/2.2-latest/MathJax.js?config=TeX-AMS_HTML',
        'tabSpaces': 4,
        'allowedContent': True
    }
}
